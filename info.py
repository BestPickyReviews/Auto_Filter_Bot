...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002832129962 -1002724814008 -1002273332873').split()]  # Channel id for auto indexing (make sure bot is admin)
