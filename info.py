...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5207748612').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002273332873 -1002724814008 -1002832129962 ').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'Contact Admin')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Contact Admin')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://punitprabhat9:7!vx3y8WLrV_5GC@cluster0.5nhl4c0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_open_fifolink/3')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open_fifolink/3')  # Tutorial video link for opening shortlink website
...
OWNERID = int(os.environ.get('OWNERID', '5207748612'))  # Replace with the actual admin ID
...
MAX_B_TN = environ.get("MAX_B_TN", "4")
